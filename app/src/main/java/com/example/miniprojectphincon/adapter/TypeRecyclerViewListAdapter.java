...
import com.example.miniprojectphincon.databinding.ListTypeItemBinding;
import com.example.miniprojectphincon.model.pokemoninfo.PokemonTypeColor;
...
public class TypeRecyclerViewListAdapter extends ListAdapter<TypesResponse, TypeRecyclerViewListAdapter.RecyclerViewViewHolder> {
    ...
    public RecyclerViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ListTypeItemBinding typeItemBinding = ListTypeItemBinding.inflate(LayoutInflater.from(context), parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerViewViewHolder holder, int position) {
        ...
        holder.typeItemBinding.cardView.setCardBackgroundColor(context.getResources().getColor(pokemonTypeColor.getTypeColor(typePoke)));
    }
    ...
    public static class RecyclerViewViewHolder extends RecyclerView.ViewHolder {
        ...
        private final ListTypeItemBinding typeItemBinding;

        public RecyclerViewViewHolder(ListTypeItemBinding typeItemBinding) {
