...
import com.example.miniprojectphincon.database.PokemonListDAO;
...
public class MainRepository {
    ...
    @Inject PokemonListDAO pokemonListDAO;
    ...
    public void fetchPokemonList(int offset) {
        ...
        Observable<PokemonListAPI> pokemonListAPIObservable = apiClient.fetchPokemonList(offset);
