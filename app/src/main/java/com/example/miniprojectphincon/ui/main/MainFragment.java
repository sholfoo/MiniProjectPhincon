...
import com.example.miniprojectphincon.adapter.PokemonRecyclerViewListAdapter;
import com.example.miniprojectphincon.base.BaseFragment;
import com.example.miniprojectphincon.databinding.FragmentMainBinding;
import com.example.miniprojectphincon.repository.MainRepository;
import com.example.miniprojectphincon.ui.detail.DetailPokeActivity;
import com.example.miniprojectphincon.ui.favorite.FavoritePokeActivity;
import com.example.miniprojectphincon.viewmodel.MainViewModel;

import org.jetbrains.annotations.NotNull;

public class MainFragment extends BaseFragment implements PokemonRecyclerViewListAdapter.OnItemClickListener {
    ...
    private void setupGotoFavoriteActivity() {
        fragmentMainBinding.actionFavoriteList.setOnClickListener(view -> {
            Intent intent = new Intent(getActivity(), FavoritePokeActivity.class);
    ...
    public void onClick(String namePoke, String imagePoke) {
        Intent intent = new Intent(getActivity(), DetailPokeActivity.class);
